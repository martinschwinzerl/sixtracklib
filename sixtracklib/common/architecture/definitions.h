...
typedef SIXTRL_INT32_T  NS(arch_status_t);
    ...
    typedef void* NS(lib_handle_t);
    typedef void const* NS(const_lib_handle_t);
#elif defined( __WIN32__ ) || defined( _WIN32 )
    typedef ::HMODULE NS(lib_handle_t);
    typedef ::HMODULE const NS(lib_handle_t);
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    typedef ::NS(lib_handle_t)           lib_handle_t;
    typedef ::NS(const_lib_handle_t)     const_lib_handle_t;
