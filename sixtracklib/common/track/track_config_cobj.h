#ifndef SIXTRACKLIB_COMMON_TRACK_TRACK_CONFIG_COBJ_H__
#define SIXTRACKLIB_COMMON_TRACK_TRACK_CONFIG_COBJ_H__
...
#endif /* !defined(  _GPUCODE ) && defined( __cplusplus ) */
#endif /* SIXTRACKLIB_COMMON_TRACK_TRACK_CONFIG_COBJ_H__  */
