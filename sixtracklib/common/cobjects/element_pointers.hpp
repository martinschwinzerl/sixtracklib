...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    {
        static constexpr cobj_size_t min_num_ptrs = cobj_size_t{ 0 };
        static constexpr cobj_size_t max_num_ptrs = cobj_size_t{ 0 };
    };

    template< class Elem, typename _Enabled >
    constexpr cobj_size_t CObjElemNumPointers< Elem, _Enabled >::min_num_ptrs;

    template< class Elem, typename _Enabled >
    constexpr cobj_size_t CObjElemNumPointers< Elem, _Enabled >::max_num_ptrs;
    ...
    {
        static constexpr cobj_size_t min_num_ptrs =
            CObjElemNumPointers< typename ObjDataCApiTypeTraits<
                E >::c_api_t >::min_num_ptrs;

        static constexpr cobj_size_t max_num_ptrs =
            CObjElemNumPointers< typename ObjDataCApiTypeTraits<
                E >::c_api_t >::max_num_ptrs;
    };

    template< class E >
    constexpr cobj_size_t CObjElemNumPointers< E, typename std::enable_if<
    ...
    template< class E >
    static SIXTRL_FN constexpr cobj_size_t
    ...
    {
        static SIXTRL_INLINE SIXTRL_FN cobj_size_t num_ptrs(
            const Elem *const SIXTRL_RESTRICT /* ptr_elem */
        ...
        CObjElem_definitely_has_no_ptrs() SIXTRL_NOEXCEPT
    {
        ...
        ( SIXTRL_CXX_NAMESPACE::CObjElem_max_num_ptrs< E >() ==
          SIXTRL_CXX_NAMESPACE::cobj_size_t{ 0 } );
    }
    ...
    static SIXTRL_FN constexpr typename std::enable_if<
        ...
        cobj_size_t >::type CObjElem_num_ptrs(
         ...
         ptr_elem = nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        cobj_size_t num_ptrs = st::CObjElemNumPointersInspector<
            E >::num_ptrs( ptr_elem );
        ...
        else if( ( st::CObjElem_min_num_ptrs< E >() > cobj_size_t{ 0 } ) &&
        ...
        /* ptr_elem */ = nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        return st::CObjElem_min_num_ptrs< Elem >();
    }
    ...
    template< class E, cobj_size_t Idx >
    static SIXTRL_FN constexpr typename std::enable_if<
       !SIXTRL_CXX_NAMESPACE::CObjElem_consistent_minmax_ptrs< E >() ||
    ...
    static SIXTRL_FN constexpr typename std::enable_if<
        !SIXTRL_CXX_NAMESPACE::CObjElem_consistent_minmax_ptrs< E >() ||
         SIXTRL_CXX_NAMESPACE::CObjElem_definitely_has_no_ptrs< E >(),
         bool >::type
    CObjElem_dataptr_index_legal( cobj_size_t const /* idx */,
    ...
    static SIXTRL_INLINE SIXTRL_FN bool CObjElem_dataptr_index_illegal(
        cobj_size_t const idx, SIXTRL_BUFFER_OBJ_DATAPTR_DEC const E *const
            SIXTRL_RESTRICT ptr ) SIXTRL_NOEXCEPT
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        return !st::CObjElem_dataptr_index_legal( idx, ptr );
    }
}
