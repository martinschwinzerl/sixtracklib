...
//         !SIXTRL_CXX_NAMESPACE::CObjElem_allow_derived_storage< E >();
    ...
    CObjElem_required_num_objects(
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
            SIXTRL_UNUSED( ptr_elem ) = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
    {
        return SIXTRL_CXX_NAMESPACE::cobj_size_type{ 1 };
    }
    ...
    static SIXTRL_INLINE SIXTRL_FN typename std::enable_if<
       ...
       !SIXTRL_CXX_NAMESPACE::ObjData_has_equivalent_c_api_type< E >(),
        SIXTRL_CXX_NAMESPACE::cobj_size_type >::type CObjElem_required_num_bytes(
            ...
            nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type slot_based_size = st::cobj_size_type{ 0 };

        st::cobj_size_type constexpr MAX_NUM_PTRS =
            st::CObjElem_max_num_ptrs< E >();

        SIXTRL_BUFFER_ARGPTR_DEC st::cobj_size_type counts[ MAX_NUM_PTRS ];

        if( st::CObjElemFieldCounts< E >::init_field_counts(
                &counts[ 0 ], MAX_NUM_PTRS, ptr_elem ) == st::STATUS_SUCCESS ) {
            ...
            nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        st_size_type slot_based_size = st_size_type{ 0 };
        st_size_type constexpr MAX_NUM_PTRS = st::CObjElem_max_num_ptrs< E >();

        SIXTRL_ARGPTR_DEC st_size_type sizes[ MAX_NUM_PTRS ];
        SIXTRL_ARGPTR_DEC st_size_type counts[ MAX_NUM_PTRS ];

        st_size_type const num_ptrs = st::CObjElem_num_ptrs< E >( ptr_elem );
            ...
            nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type const num_ptrs =
            st::CObjElem_num_ptrs< E >( ptr_elem );

        SIXTRL_ASSERT( num_ptrs <= MAX_NUM_PTRS );

        std::vector< st::cobj_size_type > sizes( MAX_NUM_PTRS );
        std::vector< st::cobj_size_type > counts( MAX_NUM_PTRS );
    ...
    static SIXTRL_INLINE SIXTRL_FN typename std::enable_if<
        ...
        SIXTRL_CXX_NAMESPACE::ObjData_has_equivalent_c_api_type< E >(),
        SIXTRL_CXX_NAMESPACE::cobj_size_type >::type
    CObjElem_required_num_bytes( ::NS(cobj_size_type) const slot_size =
            SIXTRL_CXX_NAMESPACE::CBUFFER_DEFAULT_SLOT_SIZE,
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
            ptr_elem = nullptr ) SIXTRL_NOEXCEPT {
        return SIXTRL_CXX_NAMESPACE::CObjElem_required_num_bytes<
            typename SIXTRL_CXX_NAMESPACE::ObjDataCApiTypeTraits< E
                >::c_api_type>( slot_size, ObjData_bitcast_to_const_c_api<
                    E >( ptr_elem ) ); }
    ...
    static SIXTRL_INLINE SIXTRL_FN typename std::enable_if<
        ...
        SIXTRL_CXX_NAMESPACE::cobj_size_type >::type
    CObjElem_required_num_bytes( cobj_size_type const slot_size =
            SIXTRL_CXX_NAMESPACE::CBUFFER_DEFAULT_SLOT_SIZE,
    ...
    */
    ...
    static SIXTRL_FN constexpr typename std::enable_if<
        ...
        ::NS(cobj_size_type) >::type CObjElem_required_num_bytes(
        ::NS(cobj_size_type) const SIXTRL_UNUSED( slot_size ) =
            SIXTRL_CXX_NAMESPACE::CBUFFER_DEFAULT_SLOT_SIZE,
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
            SIXTRL_UNUSED( ptr_elem ) = nullptr ) SIXTRL_NOEXCEPT
    {
        return ::NS(cobj_size_type){ 0 };
    }

    /* --------------------------------------------------------------------- */

    template< class E >
    static SIXTRL_FN ::NS(cobj_size_type) CObjElem_required_num_slots(
        ::NS(cobj_size_type) const slot_size =
            SIXTRL_CXX_NAMESPACE::CBUFFER_DEFAULT_SLOT_SIZE,
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
            ptr_elem = nullptr ) SIXTRL_NOEXCEPT
    {
        return ( slot_size > ::NS(cobj_size_type){ 0 } )
...
//             ( ( index_obj != nullptr ) &&
//               ( st::cobj_size_type{ 0 } < ::NS(CObjIndex_size)( index_obj ) ) &&
...
//     }
    ...
    CObjElem_const_from_cobj_index( SIXTRL_BUFFER_OBJ_ARGPTR_DEC const
            ::NS(CObjIndex) *const SIXTRL_RESTRICT index_obj,
        cobj_size_type const slot_size =
            SIXTRL_CXX_NAMESPACE::CBUFFER_DEFAULT_SLOT_SIZE,
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
    ...
    */
    ...
    CObjElem_load_from_flat_cbuffer_to_argptr(
        SIXTRL_BUFFER_DATAPTR_DEC ::NS(cobj_raw_type) const* SIXTRL_RESTRICT buffer,
        ...
        return ::NS(CObjFlatBuffer_load_obj_same_layout_parameters_to_argptr)(
            buffer, pos_in_buffer, slot_size,
                SIXTRL_CXX_NAMESPACE::CObjElem_type_id< E >(), ptr_obj_to_update,
                    sizeof( E ), ::NS(cobj_size_type){ 0 }, nullptr, nullptr,
                        nullptr, nullptr ); }
    ...
    CObjElem_load_from_flat_cbuffer_to_argptr(
        ...
        namespace st = SIXTRL_CXX_NAMESPACE;
        typedef typename st::ObjDataCApiTypeTraits< E >::c_api_type c_api_type;

        return ::NS(CObjFlatBuffer_load_obj_same_layout_parameters_to_argptr)(
            buffer, pos_in_buffer, slot_size,
                SIXTRL_CXX_NAMESPACE::CObjElem_type_id< c_api_type >(),
                    st::ObjData_bitcast_to_c_api< E >( ptr_obj_to_update ),
                        sizeof( c_api_type ), st::cobj_size_type{ 0 }, nullptr,
    ...
    ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type constexpr MAX_NUM_PTRS = st::CObjElem_max_num_ptrs< E >();
        st::cobj_size_type dest_counts[ MAX_NUM_PTRS ];
        st::cobj_size_type const num_pointers = st::CObjElem_num_ptrs< E >( src );
        ...
        {
            st::cobj_size_type src_counts[ MAX_NUM_PTRS ];
            ...
            if( status == st::STATUS_SUCCESS )
            {
                for( st::cobj_size_type ii = st::cobj_size_type{ 0 } ;
                    ii < num_pointers ; ++ii )
                {
        ...
        if( status == st::STATUS_SUCCESS )
        {
            st::cobj_size_type save_ptrs[ MAX_NUM_PTRS ];
    ...
    CObjElem_load_from_flat_cbuffer_to_argptr(
        ...
        return st::CObjElem_load_from_flat_cbuffer_to_argptr< c_api_type >(
            buffer, pos_in_buffer, slot_size,
                st::ObjData_bitcast_to_c_api< E >( ptr_obj_to_update ) ); }
    ...
    ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_status_type status = st::STATUS_GENERAL_FAILURE;
        static_assert( MAX_NUM_PTRS > st::cobj_size_type{ 0 },
        ...
        st::cobj_size_type const num_pointers =
            st::CObjElem_num_ptrs< E >( ptr_obj_to_update );

        SIXTRL_ASSERT( num_pointers <= MAX_NUM_PTRS );

        st::cobj_size_type dest_offsets[ MAX_NUM_PTRS ];
        st::cobj_size_type dest_counts[ MAX_NUM_PTRS ];
        st::cobj_size_type dest_sizes[ MAX_NUM_PTRS ];
            ...
            ( num_pointers == st::CObjElem_num_ptrs< E >( src ) ) )
        {
            ...
            st::cobj_size_type src_offsets[ MAX_NUM_PTRS ];
            st::cobj_size_type src_counts[ MAX_NUM_PTRS ];
            st::cobj_size_type src_sizes[ MAX_NUM_PTRS ];
        ...
        SIXTRL_BUFFER_ARGPTR_DEC E* SIXTRL_RESTRICT ptr_obj_to_update )
    {
        ...
        std::vector< st::cobj_size_type > dest_offsets( MAX_NUM_PTRS );
        std::vector< st::cobj_size_type > dest_counts( MAX_NUM_PTRS );
        std::vector< st::cobj_size_type > dest_sizes( MAX_NUM_PTRS );

        if( ( src != nullptr ) &&
            ( num_pointers == st::CObjElem_num_ptrs< E >( src ) ) )
        {
            std::vector< st::cobj_size_type > src_offsets( MAX_NUM_PTRS );
            std::vector< st::cobj_size_type > src_counts( MAX_NUM_PTRS );
            std::vector< st::cobj_size_type > src_sizes( MAX_NUM_PTRS );
        ...
        if( status == st::STATUS_SUCCESS )
        {
            std::vector< st::cobj_size_type > save_ptrs( MAX_NUM_PTRS );
    ...
    static SIXTRL_FN constexpr typename std::enable_if<
       ...
       SIXTRL_CXX_NAMESPACE::cobj_status_type >::type
    CObjElem_load_from_flat_cbuffer_to_argptr(
        SIXTRL_BUFFER_DATAPTR_DEC ::NS(cobj_raw_type) const*
            SIXTRL_RESTRICT SIXTRL_UNUSED( buffer ),
        NS(cobj_size_type) const SIXTRL_UNUSED( pos_in_buffer ),
        NS(cobj_size_type) const SIXTRL_UNUSED( slot_size ),
    ...
    CObjElem_store_to_flat_cbuffer_from_argptr(
        SIXTRL_BUFFER_DATAPTR_DEC ::NS(cobj_raw_type)* SIXTRL_RESTRICT buffer,
        ::NS(cobj_size_type) const pos_in_buffer, ::NS(cobj_size_type) const slot_size,
        ...
        return ::NS(CObjFlatBuffer_store_obj_same_layout_parameters_from_argptr)(
            buffer, pos_in_buffer, slot_size, st::CObjElem_type_id< E >(),
                ptr_to_source, sizeof( E ), st::cobj_size_type{ 0 },
    ...
    CObjElem_store_to_flat_cbuffer_from_argptr(
        ...
        return SIXTRL_CXX_NAMESPACE::CObjElem_store_to_flat_cbuffer_from_argptr<
            typename ObjDataCApiTypeTraits< E >::c_api_type>( buffer,
    ...
    ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type const num_ptrs = st::CObjElem_num_ptrs< E >( dest );
    ...
    CObjElem_store_to_flat_cbuffer_from_argptr(
        ...
        namespace st = SIXTRL_CXX_NAMESPACE;
        typedef typename st::ObjDataCApiTypeTraits< E >::c_api_type c_api_type;
        return st::CObjElem_store_to_flat_cbuffer_from_argptr< c_api_type >(
            buffer, pos_in_buffer, slot_size,
    ...
    CObjElem_store_to_flat_cbuffer_from_argptr(
        ...
        return st::CObjElem_store_to_flat_cbuffer_from_argptr< typename
            st::ObjDataCApiTypeTraits< E >::c_api_type>( buffer, pos_in_buffer,
        ...
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT ptr_to_source )
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        return st::CObjElem_store_to_flat_cbuffer_from_argptr< typename
            ObjDataCApiTypeTraits< E >::c_api_type>( buffer, pos_in_buffer,
                slot_size, st::ObjData_bitcast_to_const_c_api< E >(
                    ptr_to_source ) );
    }
    ...
    static SIXTRL_FN constexpr typename std::enable_if<
       ...
       !SIXTRL_CXX_NAMESPACE::CObjElem_is_cobj_storage_interface< E >(),
        SIXTRL_CXX_NAMESPACE::cobj_status_type >::type
    CObjElem_store_to_flat_cbuffer_from_argptr(
        SIXTRL_BUFFER_DATAPTR_DEC NS(cobj_raw_type)* SIXTRL_RESTRICT
    ...
    CObjElem_can_add_copy_of_object(
        ...
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT requ_num_slots,
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT requ_num_objs,
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT requ_num_ptrs
    ) SIXTRL_NOEXCEPT {
        return ::NS(CObjFlatBuffer_can_add_copy_of_object)(
            buffer, slot_size, sizeof( E ), ::NS(cobj_size_type){ 0 }, nullptr,
            nullptr, requ_buffer_size, requ_num_slots, requ_num_objs,
                requ_num_ptrs ); }
    ...
    ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type constexpr MAX_NUM_PTRS =
            st::CObjElem_max_num_ptrs< E >();
        st::cobj_size_type counts[ MAX_NUM_PTRS ];
    ...
    ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type sizes[ MAX_NUM_PTRS ];
        st::cobj_size_type counts[ MAX_NUM_PTRS ];
        ...
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT requ_num_ptrs )
    {
        ...
        typedef st::cobj_size_type st_size_type;
        st_size_type constexpr MAX_NUM_PTRS = st::CObjElem_max_num_ptrs< E >();
        st_size_type const num_pointers = st::CObjElem_num_ptrs< E >( ptr_elem );

        SIXTRL_ASSERT( num_pointers <= MAX_NUM_PTRS );
        std::vector< st_size_type > sizes( MAX_NUM_PTRS );
        std::vector< st_size_type > counts( MAX_NUM_PTRS );
        ...
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT requ_num_ptrs )
    {
        return SIXTRL_CXX_NAMESPACE::CObjElem_can_add_copy_of_object<
            typename ObjDataCApiTypeTraits< E >::c_api_type>( buffer, slot_size,
                SIXTRL_CXX_NAMESPACE::ObjData_bitcast_to_const_c_api< E >(
    ...
    */
    ...
    CObjElem_can_add_copy_of_object(
        ...
        SIXTRL_ARGPTR_DEC ::NS(cobj_size_type)* SIXTRL_RESTRICT
            SIXTRL_UNUSED( requ_num_ptrs ) ) SIXTRL_NOEXCEPT { return false; }
    */
    ...
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        typedef cobj_size_type _size_t;
    ...
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        NS(cobj_obj_index_pointer) index_added_obj = nullptr;
        ...
        bool const init_with_zeros = false ) SIXTRL_NOEXCEPT
    {
        ...
        st::cobj_size_type offsets[ MAX_NUM_PTRS ];
        st::cobj_size_type sizes[ MAX_NUM_PTRS ];
        st::cobj_size_type counts[ MAX_NUM_PTRS ];
        ...
        bool const init_with_zeros = false )
    {
        ...
        std::vector< cobj_size_type > offsets( MAX_NUM_PTRS );
        std::vector< cobj_size_type > sizes( MAX_NUM_PTRS );
        std::vector< cobj_size_type > counts( MAX_NUM_PTRS );
