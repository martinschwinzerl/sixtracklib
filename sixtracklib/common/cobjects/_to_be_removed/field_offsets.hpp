...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    {
        static constexpr cobj_size_type offsets[ 1 ] = { cobj_size_type{ 0 } };
    };

    template< class E >
    constexpr cobj_size_type CObjElemFieldOffsets< E >::offsets[];
            ...
            E >() >::type >
    {
        static SIXTRL_INLINE SIXTRL_FN cobj_status_type init_field_offsets(
            ...
            SIXTRL_ARGPTR_DEC cobj_size_type const max_num_offsets,
            SIXTRL_BUFFER_ARGPTR_DEC const E *const
                SIXTRL_RESTRICT ptr = nullptr ) SIXTRL_NOEXCEPT
        {
            namespace st = SIXTRL_CXX_NAMESPACE;
            typedef typename st::ObjDataCObjectsTypeIdTraits<
                E >::c_api_type c_api_type;

            return CObjElemFieldOffsetsInspector<
                c_api_type >::init_field_offsets( offsets_begin, max_num_offsets,
    ...
    CObjElem_field_offsets(
        ...
        SIXTRL_CXX_NAMESPACE::cobj_size_type const max_num_offsets_to_store,
        SIXTRL_BUFFER_ARGPTR_DEC const E *const SIXTRL_RESTRICT
            /* ptr */ = nullptr ) SIXTRL_NOEXCEPT
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
            ...
            SIXTRL_UNUSED( ptr ) = nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        namespace st = SIXTRL_CXX_NAMESPACE;
        st::CObjElem_init_array_with_two_values( offsets_begin,
            max_num_offsets_to_store, sizeof( c_api_type ) );
    ...
    {
        typedef typename ObjDataCApiTypeTraits< E >::c_api_type c_api_type;
        return SIXTRL_CXX_NAMESPACE::CObjElem_field_offsets< c_api_type >(
            ...
            ptr = nullptr ) SIXTRL_NOEXCEPT
    {
        ...
        if( ndataptrs > st::cobj_size_type{ 0 } )
        {
            if( ( offsets_begin != nullptr ) &&
                ( max_num_offsets_to_store > st::cobj_size_type{ 0 } ) )
            {
