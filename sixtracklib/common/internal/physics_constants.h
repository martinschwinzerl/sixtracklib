...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_clight_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
        *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_clight<
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_epsilon0_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
        *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_epsilon0<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mu0_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
        *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mu0<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_atomic_si_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_atomic_si<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_atomic_ev_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_atomic_ev<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_proton_si_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_proton_si<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_proton_ev_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_proton_ev<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_electron_si_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_electron_si<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_mass_electron_ev_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_mass_electron_ev<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_charge0_si_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_charge0_si<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    PhysConst_charge0_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
        *const SIXTRL_RESTRICT SIXTRL_UNUSED( p ) = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::PhysConst_charge0<
            typename ParticleTraits< ParticleT >::real_t >();
    }
}
...
NS(PhysConst_clight_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
    *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_clight_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_epsilon0_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
    *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_epsilon0_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mu0_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const ParticleT
    *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mu0_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_atomic_si_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mass_atomic_si_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_atomic_ev_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mass_atomic_ev_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_proton_si_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mass_proton_si_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_proton_ev_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
...
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_electron_si_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mass_electron_si_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_mass_electron_ev_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_mass_electron_ev_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_charge0_si_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::PhysConst_charge0_si_for_particle( p );
}

template< class ParticleT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(PhysConst_charge0_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const SIXTRL_RESTRICT p = SIXTRL_NULLPTR )
{
...
NS(PhysConst_clight_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    struct NS(Particle) *const SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN NS(particle_real_t)
NS(PhysConst_epsilon0_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    struct NS(Particle) *const SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN NS(particle_real_t)
NS(PhysConst_mu0_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    struct NS(Particle) *const SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;
...
SIXTRL_STATIC SIXTRL_FN NS(particle_real_t)
NS(PhysConst_mass_electron_si_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC
    const struct NS(Particle) *const SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;
...
SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_clight_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_CLIGHT;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_epsilon0_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_EPSILON0;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mu0_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MU0;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_atomic_si_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_ATOMIC_SI;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_atomic_ev_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_ATOMIC_EV;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_charge0_si_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_CHARGE0_SI;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_charge0_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_CHARGE0;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_proton_si_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_PROTON_SI;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_proton_ev_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_PROTON_EV;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_electron_si_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_ELECTRON_SI;
}

SIXTRL_INLINE NS(particle_real_t) NS(PhysConst_mass_electron_ev_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /* p */ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_PHYS_CONST_MASS_ELECTRON_EV;
}
