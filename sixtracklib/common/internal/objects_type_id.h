...
typedef enum NS(object_type_values_e)
{
    ...
    NS(OBJECT_TYPE_ELEM_BY_ELEM_CONF)     =      65532,
    NS(OBJECT_TYPE_OUT_ADDR_ASSIGN_ITEM)  =      65333,
    NS(OBJECT_TYPE_BINARY_PATCH_ITEM)     =      65334,
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    SIXTRL_STATIC_VAR SIXTRL_CONSTEXPR_OR_CONST object_type_id_t
        OBJECT_TYPE_OUT_ADDR_ASSIGN_ITEM = static_cast< object_type_id_t >(
