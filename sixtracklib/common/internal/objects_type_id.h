...
typedef enum NS(object_type_values_e)
{
    ...
    NS(OBJECT_TYPE_PARTICLE_SET_STATE)       =        513,
    NS(OBJECT_TYPE_PARTICLE_SET_STATISTICS)  =        514,
    NS(OBJECT_TYPE_PARTICLE_SETS_SELECTION)  =        515,
    NS(OBJECT_TYPE_ASSIGN_ADDRESS_ITEM)      =        516,
    NS(OBJECT_TYPE_BINARY_PATCH_ITEM)        =        517,
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    SIXTRL_STATIC_VAR SIXTRL_CONSTEXPR_OR_CONST object_type_id_t
        OBJECT_TYPE_PARTICLE_SET_STATE = static_cast< object_type_id_t >(
            NS(OBJECT_TYPE_PARTICLE_SET_STATE) );

    SIXTRL_STATIC_VAR SIXTRL_CONSTEXPR_OR_CONST object_type_id_t
        OBJECT_TYPE_PARTICLE_SET_STATISTICS = static_cast< object_type_id_t >(
            NS(OBJECT_TYPE_PARTICLE_SET_STATISTICS) );

    SIXTRL_STATIC_VAR SIXTRL_CONSTEXPR_OR_CONST object_type_id_t
        OBJECT_TYPE_PARTICLE_SETS_SELECTION = static_cast< object_type_id_t >(
