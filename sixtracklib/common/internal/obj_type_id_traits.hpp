#ifndef SIXTRACKLIB_COMMON_INTERNAL_OBJ_TYPE_ID_TRAITS_CXX_HPP__
#define SIXTRACKLIB_COMMON_INTERNAL_OBJ_TYPE_ID_TRAITS_CXX_HPP__
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    struct ObjTypeIdTraits;

    template< typename TypeIdType >
    struct ObjTypeIdTraits< TypeIdType, typename std::enable_if<
        std::numeric_limits< TypeIdType >::is_integer >::type >
    {
    ...
    struct GenericTypeIdOperations
    {
        static_assert( 1 != 0, "Should never get here" );
    };

    template< class TypeIdTypeTraits >
    struct GenericTypeIdOperations< TypeIdTypeTraits, typename std::enable_if<
        std::numeric_limits<
            typename TypeIdTypeTraits::type_id_t >::is_integer &&
        std::numeric_limits< typename TypeIdTypeTraits::type_id_t >::digits >=
            ( TypeIdTypeTraits::BaseTypeNumBits() +
    ...
    using TypeIdOperations = GenericTypeIdOperations<
        ObjTypeIdTraits< TypeIdT >, TypeIdT >;
    ...
    template< typename TypeIdT >
    static SIXTRL_FN constexpr TypeIdT ObjTypeId_max_type_id() SIXTRL_NOEXCEPT
    {
        return TypeIdOperations< TypeIdT >::max_type_id();
    }

    template< typename TypeIdT >
    static SIXTRL_FN constexpr TypeIdT ObjTypeId_min_type_id() SIXTRL_NOEXCEPT
    {
        return TypeIdOperations< TypeIdT >::min_type_id();
    }

    template< typename TypeIdT >
    static SIXTRL_FN constexpr TypeIdT ObjTypeId_min_variant() SIXTRL_NOEXCEPT
    {
        return TypeIdOperations< TypeIdT >::min_variant();
    }

    template< typename TypeIdT >
    static SIXTRL_FN constexpr TypeIdT ObjTypeId_max_variant() SIXTRL_NOEXCEPT
    {
    ...
    {
        return TypeIdOperations<
            TypeIdT >::template remove_variant< variant_type_id >();
    }

    template< typename TypeIdT >
    static SIXTRL_INLINE SIXTRL_FN TypeIdT ObjTypeId_remove_variant(
        TypeIdT const variant_type_id ) SIXTRL_NOEXCEPT
    {
...
#endif /* SIXTRACKLIB_COMMON_INTERNAL_OBJ_TYPE_ID_TRAITS_CXX_HPP__ */
