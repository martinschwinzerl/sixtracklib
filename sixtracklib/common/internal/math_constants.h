...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    MathConst_pi_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const /* p */ = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::MathConst_pi<
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    MathConst_deg2rad_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const /* p */ = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::MathConst_deg2rad<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    MathConst_rad2deg_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const /* p */ = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::MathConst_rad2deg<
            typename ParticleTraits< ParticleT >::real_t >();
    }
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename ParticleTraits<
        ParticleT >::real_t
    MathConst_sqrt_pi_for_particle( SIXTRL_PARTICLE_ARGPTR_DEC const
        ParticleT *const /* p */ = SIXTRL_NULLPTR )
    {
        return SIXTRL_CXX_NAMESPACE::MathConst_sqrt_pi<
            typename ParticleTraits< ParticleT >::real_t >();
    }
}
...
NS(MathConst_pi_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::MathConst_pi_for_particle<
        ParticleT >( p );
}
...
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(MathConst_deg2rad_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::MathConst_deg2rad_for_particle<
        ParticleT >( p );
}
...
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(MathConst_rad2deg_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::MathConst_rad2deg_for_particle<
        ParticleT >( p );
}
...
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN typename
    SIXTRL_CXX_NAMESPACE::ParticleTraits< ParticleT >::real_t
NS(MathConst_sqrt_pi_for_particle)( SIXTRL_PARTICLE_ARGPTR_DEC const
    ParticleT *const p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::MathConst_sqrt_pi_for_particle<
        ParticleT >( p );
}
...
SIXTRL_STATIC SIXTRL_FN NS(particle_real_t) NS(MathConst_pi_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN NS(particle_real_t) NS(MathConst_deg2rad_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN NS(particle_real_t) NS(MathConst_rad2deg_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN NS(particle_real_t) NS(MathConst_sqrt_pi_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT p ) SIXTRL_NOEXCEPT;
...
SIXTRL_INLINE NS(particle_real_t) NS(MathConst_pi_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const NS(Particle) *const
        SIXTRL_RESTRICT /*p*/ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_MATH_CONST_PI;
}

SIXTRL_INLINE NS(particle_real_t) NS(MathConst_deg2rad_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT /*p*/ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_MATH_CONST_DEG2RAD;
}

SIXTRL_INLINE NS(particle_real_t) NS(MathConst_rad2deg_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT /*p*/ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_MATH_CONST_RAD2DEG;
}

SIXTRL_INLINE NS(particle_real_t) NS(MathConst_sqrt_pi_for_particle)(
    SIXTRL_PARTICLE_ARGPTR_DEC const struct NS(Particle) *const
        SIXTRL_RESTRICT /*p*/ ) SIXTRL_NOEXCEPT
{
    return ( NS(particle_real_t) )SIXTRL_MATH_CONST_SQRT_PI;
}
