...
SIXTRL_BE_ARGPTR_DEC NS(LimitRect) const* NS(LimitRect_const_from_cbuffer_ext)(
...
SIXTRL_BE_ARGPTR_DEC NS(LimitRect)* NS(LimitRect_from_cbuffer_ext)(
...
SIXTRL_BE_ARGPTR_DEC NS(LimitRect)* NS(LimitRect_cbuffer_new_ext)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer ) {
    return NS(LimitRect_cbuffer_new)( buffer ); }

SIXTRL_BE_ARGPTR_DEC NS(LimitRect)* NS(LimitRect_cbuffer_add_ext)(
...
SIXTRL_BE_ARGPTR_DEC NS(LimitRect)* NS(LimitRect_cbuffer_add_copy_ext)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
