...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(LimitRect) const*
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(LimitRect) const*
NS(LimitRect_const_from_cbuffer_ext)(
    SIXTRL_CBUFFER_ARGPTR_DEC const struct NS(CBuffer) *const SIXTRL_RESTRICT b,
    NS(cobj_size_type) const idx ) SIXTRL_NOEXCEPT;

SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(LimitRect)*
...
/* ========================================================================= */
    ...
    #include "sixtracklib/common/beam_elements/limit/limit_rect_cobj.h"
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(LimitRect) const*
...
NS(LimitRect_from_cobj_index)(
    SIXTRL_CBUFFER_OBJ_ARGPTR_DEC NS(CObjIndex)* obj ) SIXTRL_NOEXCEPT {
    return ( SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(LimitRect)*
