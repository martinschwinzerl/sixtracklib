#ifndef SIXTRACKLIB_COMMON_BEAM_ELEMENTS_LIMIT_LIMIT_ELLIPSE_COBJ_H__
#define SIXTRACKLIB_COMMON_BEAM_ELEMENTS_LIMIT_LIMIT_ELLIPSE_COBJ_H__
...
NS(LimitEllipse_cobj_flat_buffer_new)(
    ...
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
    SIXTRL_BE_ARGPTR_DEC NS(LimitEllipse) elem;
...
NS(LimitEllipse_cobj_flat_buffer_add)(
    ...
    SIXTRL_BE_ARGPTR_DEC NS(LimitEllipse) e;
...
#endif /* !defined(  _GPUCODE ) && defined( __cplusplus ) */
#endif /* SIXTRACKLIB_COMMON_BEAM_ELEMENTS_LIMIT_LIMIT_ELLIPSE_COBJ_H__  */
