#ifndef SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DRIFT_EXACT_DRIFT_EXACT_COBJECTS_API_H__
#define SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DRIFT_EXACT_DRIFT_EXACT_COBJECTS_API_H__
...
namespace SIXTRL_CXX_NAMESPACE
{
    template<> struct ObjTypeIdDataTypeMap<
        cobj_type_id_t, SIXTRL_CXX_NAMESPACE::OBJECT_TYPE_DRIFT_EXACT >
    {
        typedef ::NS(DriftExact) value_type;
    };

    template<> struct ObjDataTypeIdTraits< ::NS(DriftExact), cobj_type_id_t >
    {
        static_assert(
            SIXTRL_CXX_NAMESPACE::ObjData_is_c_api_type< ::NS(DriftExact) >(),
            "NS(DriftExact) should be a C-API type" );
    ...
    SIXTRL_STATIC SIXTRL_FN constexpr cobj_type_id_t DriftExact_type_id(
        SIXTRL_BE_ARGPTR_DEC const ::NS(DriftExact) *const SIXTRL_RESTRICT
            /* p */ = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
    {
        return ObjDataTypeIdTraits< ::NS(DriftExact),
    ...
    SIXTRL_STATIC SIXTRL_FN constexpr typename std::enable_if<
        ...
        cobj_size_t >::type
    DriftExact_num_pointers( SIXTRL_BE_ARGPTR_DEC const DriftExactT *const
        SIXTRL_RESTRICT /* p  */ = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
    {
        return SIXTRL_CXX_NAMESPACE::CObjElem_num_ptrs< DriftExactT >();
    }

    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN cobj_size_t
    DriftExact_required_num_bytes( cobj_size_t const slot_size,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
            p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        static_assert( st::ObjData_is_drift_exact< DriftExactT >(),
            "Requires DriftExactT to be a DriftExact element" );

        return SIXTRL_CXX_NAMESPACE::CObjElem_required_num_bytes< DriftExactT >(
            slot_size, p );
    }

    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN cobj_size_t
    DriftExact_required_num_slots( cobj_size_t const slot_size,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
            p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        ...
        return SIXTRL_CXX_NAMESPACE::CObjElem_required_num_slots< DriftExactT >(
            slot_size, p );
    }

    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT const*
    DriftExact_const_from_cobj_index( SIXTRL_BUFFER_OBJ_ARGPTR_DEC const
        ...
        cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
    {
        ...
        return SIXTRL_CXX_NAMESPACE::CObjElem_const_from_cobj_index<
            DriftExactT >( index_obj, slot_size );
    }

    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
    DriftExact_from_cobj_index( SIXTRL_BUFFER_OBJ_ARGPTR_DEC ::NS(CObjIndex)*
    ...
    SIXTRL_BE_ARGPTR_DEC DriftExactT const* DriftExact_const_from_flat_cbuffer(
        ...
        cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
    {
        ...
        return st::DriftExact_const_from_cobj_index< DriftExactT >(
        ...
        cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
    {
        ...
        return SIXTRL_CXX_NAMESPACE::DriftExact_from_cobj_index< DriftExactT >(
    ...
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC
        DriftExactT const*
    DriftExact_const_from_cbuffer( SIXTRL_BUFFER_ARGPTR_DEC const
        ...
        cobj_size_t const pos_in_buffer ) SIXTRL_NOEXCEPT
    {
        ...
        static_assert(
            st::ObjData_is_drift_exact< DriftExactT >(),
            "Requires DriftExactT to be a DriftExact element" );

        return ( cbuffer != SIXTRL_NULLPTR )
            ? st::DriftExact_const_from_cobj_index< DriftExactT >(
        ...
        cobj_size_t const pos_in_buffer ) SIXTRL_NOEXCEPT
    {
        ...
        return ( cbuffer != SIXTRL_NULLPTR )
            ? st::DriftExact_from_cobj_index< DriftExactT >(
                cbuffer->index_at( pos_in_buffer ), cbuffer->slot_size() )
            : SIXTRL_NULLPTR;
    }
    ...
    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_HOST_FN bool DriftExact_can_add_copy(
        SIXTRL_BUFFER_ARGPTR_DEC const CBufferView *const
            SIXTRL_RESTRICT cbuffer,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const ptr_orig,
    ...
    SIXTRL_BE_ARGPTR_DEC DriftExactT* DriftExact_add_copy(
        SIXTRL_BUFFER_ARGPTR_DEC CBufferView* SIXTRL_RESTRICT cbuffer,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const ptr_orig )
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
    ...
    template< class DriftExactT >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_HOST_FN
    SIXTRL_BE_ARGPTR_DEC DriftExactT*
    DriftExact_new(
        SIXTRL_BUFFER_ARGPTR_DEC CBufferView* SIXTRL_RESTRICT cbuffer,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
            /* p */ = SIXTRL_NULLPTR )
    {
        namespace st = SIXTRL_CXX_NAMESPACE;
        SIXTRL_BE_ARGPTR_DEC DriftExactT* added_obj = SIXTRL_NULLPTR;
        ...
        {
            SIXTRL_ARGPTR_DEC DriftExactT orig;
            st::DriftExact_init( &orig );
            added_obj = st::DriftExact_add_copy( cbuffer, &orig );
        }

        return added_obj;
    }

    template< class DriftExactT, typename... Args >
    SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
    DriftExact_add(
        SIXTRL_BUFFER_ARGPTR_DEC CBufferView* SIXTRL_RESTRICT cbuffer,
        Args&&... args,
        SIXTRL_BE_ARGPTR_DEC const DriftExactT *const
            SIXTRL_RESTRICT /* p */ = SIXTRL_NULLPTR )
    {
        ...
        {
            SIXTRL_ARGPTR_DEC DriftExactT orig;
            st::DriftExact_init( &orig, std::forward< Args >( args )... );
            added_obj = st::DriftExact_add_copy( cbuffer, &orig );
        }
...
NS(DriftExact_type_id)( SIXTRL_BE_ARGPTR_DEC const DriftExactT *const
    SIXTRL_RESTRICT p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_type_id< DriftExactT >( p );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_FN constexpr SIXTRL_CXX_NAMESPACE::cobj_size_t
NS(DriftExact_num_pointers)( SIXTRL_BE_ARGPTR_DEC const DriftExactT *const
    SIXTRL_RESTRICT p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_num_pointers< DriftExactT >( p );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_CXX_NAMESPACE::cobj_size_t
NS(DriftExact_required_num_bytes)(
    SIXTRL_CXX_NAMESPACE::cobj_size_t const slot_size,
    SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
        p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_required_num_bytes< DriftExactT >(
        slot_size, p );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_CXX_NAMESPACE::cobj_size_t
NS(DriftExact_required_num_slots)(
    SIXTRL_CXX_NAMESPACE::cobj_size_t const slot_size,
    SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
        p = SIXTRL_NULLPTR ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_required_num_slots< DriftExactT >(
        slot_size, p );
}
...
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_const_from_cobj_index<
        DriftExactT >( index_obj, slot_size );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
NS(DriftExact_from_cobj_index)( SIXTRL_BUFFER_OBJ_ARGPTR_DEC ::NS(CObjIndex)*
        SIXTRL_RESTRICT index_obj,
    SIXTRL_CXX_NAMESPACE::cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_from_cobj_index<
        DriftExactT >( index_obj, slot_size );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN
SIXTRL_BE_ARGPTR_DEC DriftExactT const* NS(DriftExact_const_from_flat_cbuffer)(
    SIXTRL_BUFFER_DATAPTR_DEC unsigned char const* SIXTRL_RESTRICT buffer,
    SIXTRL_CXX_NAMESPACE::cobj_size_t const pos_in_buffer,
    SIXTRL_CXX_NAMESPACE::cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
{
    namespace st = SIXTRL_CXX_NAMESPACE;
    return st::DriftExact_const_from_flat_cbuffer< DriftExactT >(
        buffer, pos_in_buffer, slot_size );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
NS(DriftExact_from_flat_cbuffer)(
    SIXTRL_BUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    SIXTRL_CXX_NAMESPACE::cobj_size_t const pos_in_buffer,
    SIXTRL_CXX_NAMESPACE::cobj_size_t const slot_size ) SIXTRL_NOEXCEPT
{
    namespace st = SIXTRL_CXX_NAMESPACE;
    return st::DriftExact_from_flat_cbuffer< DriftExactT >(
        buffer, pos_in_buffer, slot_size );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN
SIXTRL_BE_ARGPTR_DEC DriftExactT const*
...
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_const_from_cbuffer< DriftExactT >(
...
NS(DriftExact_from_cbuffer)(
    ...
    SIXTRL_CXX_NAMESPACE::cobj_size_t const pos_in_buffer ) SIXTRL_NOEXCEPT
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_from_cbuffer< DriftExactT >(
        cbuffer, pos_in_buffer );
}
...
template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_HOST_FN bool NS(DriftExact_can_add_copy)(
    SIXTRL_BUFFER_ARGPTR_DEC const SIXTRL_CXX_NAMESPACE::CBufferView *const
        SIXTRL_RESTRICT cbuffer,
    SIXTRL_BE_ARGPTR_DEC const DriftExactT *const ptr_orig,
...
template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_HOST_FN
SIXTRL_BE_ARGPTR_DEC DriftExactT* NS(DriftExact_add_copy)(
    SIXTRL_BUFFER_ARGPTR_DEC SIXTRL_CXX_NAMESPACE::CBufferView*
        SIXTRL_RESTRICT cbuffer,
    SIXTRL_BE_ARGPTR_DEC const DriftExactT *const ptr_orig )
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_add_copy< DriftExactT >(
        cbuffer, ptr_orig );
}

template< class DriftExactT >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_HOST_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
NS(DriftExact_new)( SIXTRL_BUFFER_ARGPTR_DEC
    SIXTRL_CXX_NAMESPACE::CBufferView* SIXTRL_RESTRICT cbuffer )
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_new< DriftExactT >( cbuffer );
}

template< class DriftExactT, typename... Args >
SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_BE_ARGPTR_DEC DriftExactT*
NS(DriftExact_add)( SIXTRL_BUFFER_ARGPTR_DEC SIXTRL_CXX_NAMESPACE::CBufferView*
        SIXTRL_RESTRICT cbuffer, Args&&... args,
    SIXTRL_BE_ARGPTR_DEC const DriftExactT *const SIXTRL_RESTRICT
        p = SIXTRL_NULLPTR )
{
    return SIXTRL_CXX_NAMESPACE::DriftExact_add< DriftExactT, Args... >(
...
NS(DriftExact_type_id)( void ) SIXTRL_NOEXCEPT;
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(DriftExact) const*
NS(DriftExact_const_from_flat_cbuffer)(
    SIXTRL_BUFFER_DATAPTR_DEC unsigned char const* SIXTRL_RESTRICT buffer,
...
SIXTRL_EXTERN SIXTRL_HOST_FN bool NS(DriftExact_can_add_copy)(
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_BE_ARGPTR_DEC NS(DriftExact)*
NS(DriftExact_new)( SIXTRL_BUFFER_ARGPTR_DEC NS(CBufferView)*
    SIXTRL_RESTRICT cbuffer );
...
SIXTRL_INLINE NS(cobj_type_id_t) NS(DriftExact_type_id)( void ) SIXTRL_NOEXCEPT
{
    return NS(OBJECT_TYPE_DRIFT_EXACT);
}

SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(DriftExact) const*
NS(DriftExact_const_from_cobj_index)( SIXTRL_BUFFER_OBJ_ARGPTR_DEC const
        NS(CObjIndex) *const SIXTRL_RESTRICT index_obj,
    NS(cobj_size_t) const slot_size ) SIXTRL_NOEXCEPT
{
    return ( SIXTRL_BE_ARGPTR_DEC NS(DriftExact) const* )( uintptr_t
        )NS(CObjIndex_begin_addr_filter_by_type_info)(
            index_obj, NS(DriftExact_type_id)(), sizeof( NS(DriftExact) ),
                slot_size );
}
...
NS(DriftExact_const_from_flat_cbuffer)(
    ...
    NS(cobj_size_t) const slot_size ) SIXTRL_NOEXCEPT
{
    return NS(DriftExact_const_from_cobj_index)( NS(CObjFlatBuffer_const_index)(
        buffer, pos_in_buffer, slot_size ), slot_size );
}
...
NS(DriftExact_from_flat_cbuffer)(
    ...
    NS(cobj_size_t) const slot_size ) SIXTRL_NOEXCEPT
{
    return NS(DriftExact_from_cobj_index)( NS(CObjFlatBuffer_index)(
        buffer, pos_in_buffer, slot_size ), slot_size );
}
...
#endif /* C++, Host */
#endif /* SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DRIFT_EXACT_DRIFT_EXACT_COBJECTS_API_H__ */
