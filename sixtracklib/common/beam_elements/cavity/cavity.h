...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity) const*
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity) const*
...
/* ************************************************************************* */
    ...
    #include "sixtracklib/common/beam_elements/cavity/cavity_cobj.h"
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity) const*
NS(Cavity_const_from_cobj_index)( SIXTRL_CBUFFER_OBJ_ARGPTR_DEC const NS(CObjIndex)
    *const SIXTRL_RESTRICT obj ) SIXTRL_NOEXCEPT {
    return ( NS(CObjIndex_is_cavity)( obj ) )
        ? ( SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity) const* )(
...
NS(Cavity_from_cobj_index)(
    ...
    return ( SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)*
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)* NS(Cavity_from_cbuffer)(
