#ifndef SIXTRACKLIB_COMMON_BEAM_ELEMENTS_CAVITY_CAVITY_API_C99_H__
#define SIXTRACKLIB_COMMON_BEAM_ELEMENTS_CAVITY_CAVITY_API_C99_H__
...
SIXTRL_STATIC SIXTRL_FN NS(buffer_size_t) NS(Cavity_get_num_dataptrs)(
    SIXTRL_BE_ARGPTR_DEC  const NS(Cavity) *const SIXTRL_RESTRICT cavity );

SIXTRL_STATIC SIXTRL_FN NS(buffer_size_t) NS(Cavity_get_num_slots)(
    SIXTRL_BE_ARGPTR_DEC  const NS(Cavity) *const SIXTRL_RESTRICT cavity,
...
SIXTRL_STATIC SIXTRL_FN NS(be_cavity_real_t) NS(Cavity_get_voltage)(
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT cavity );

SIXTRL_STATIC SIXTRL_FN NS(be_cavity_real_t) NS(Cavity_get_frequency)(
    SIXTRL_BE_ARGPTR_DEC  const NS(Cavity) *const SIXTRL_RESTRICT cavity );

SIXTRL_STATIC SIXTRL_FN NS(be_cavity_real_t) NS(Cavity_get_lag)(
    SIXTRL_BE_ARGPTR_DEC  const NS(Cavity) *const SIXTRL_RESTRICT cavity );

SIXTRL_STATIC SIXTRL_FN void NS(Cavity_set_voltage)(
    SIXTRL_BE_ARGPTR_DEC NS(Cavity)* SIXTRL_RESTRICT cavity,
    NS(be_cavity_real_t) const voltage );

SIXTRL_STATIC SIXTRL_FN void NS(Cavity_set_frequency)(
    SIXTRL_BE_ARGPTR_DEC  NS(Cavity)* SIXTRL_RESTRICT cavity,
    NS(be_cavity_real_t) const frequency );

SIXTRL_STATIC SIXTRL_FN void NS(Cavity_set_lag)(
    SIXTRL_BE_ARGPTR_DEC  NS(Cavity)* SIXTRL_RESTRICT cavity,
    NS(be_cavity_real_t) const lag );

SIXTRL_STATIC SIXTRL_FN void NS(Cavity_clear)(
    SIXTRL_BE_ARGPTR_DEC  NS(Cavity)* SIXTRL_RESTRICT cavity );

SIXTRL_STATIC SIXTRL_FN int NS(Cavity_copy)(
...
SIXTRL_STATIC SIXTRL_FN int NS(Cavity_compare_values_with_treshold)(
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT lhs,
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT rhs,
    NS(be_cavity_real_t) const treshold );

/* ------------------------------------------------------------------------- */

SIXTRL_STATIC SIXTRL_FN SIXTRL_BUFFER_DATAPTR_DEC NS(Cavity) const*
NS(BufferIndex_get_const_cavity)(
    SIXTRL_BUFFER_OBJ_ARGPTR_DEC const NS(Object) *const index_obj );

SIXTRL_STATIC SIXTRL_FN SIXTRL_BUFFER_DATAPTR_DEC NS(Cavity)*
...
SIXTRL_STATIC SIXTRL_FN bool NS(Cavity_can_be_added)(
    SIXTRL_BUFFER_ARGPTR_DEC const NS(Buffer) *const SIXTRL_RESTRICT buffer,
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BUFFER_DATAPTR_DEC NS(Cavity)* NS(Cavity_new)(
    SIXTRL_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer );

SIXTRL_STATIC SIXTRL_FN SIXTRL_BUFFER_DATAPTR_DEC NS(Cavity)* NS(Cavity_add)(
    SIXTRL_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer,
    NS(be_cavity_real_t)  const voltage, NS(be_cavity_real_t)  const frequency,
    NS(be_cavity_real_t)  const lag );
...
SIXTRL_INLINE NS(be_cavity_real_t) NS(Cavity_get_voltage)(
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT cavity )
{
...
SIXTRL_INLINE NS(be_cavity_real_t) NS(Cavity_get_frequency)(
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT cavity )
{
    SIXTRL_ASSERT( cavity != SIXTRL_NULLPTR );
...
SIXTRL_INLINE NS(be_cavity_real_t) NS(Cavity_get_lag)(
    SIXTRL_BE_ARGPTR_DEC const NS(Cavity) *const SIXTRL_RESTRICT cavity )
{
    SIXTRL_ASSERT( cavity != SIXTRL_NULLPTR );
    return cavity->lag;
...
SIXTRL_INLINE void NS(Cavity_clear)(
    SIXTRL_BE_ARGPTR_DEC NS(Cavity)* SIXTRL_RESTRICT cavity )
{
    NS(Cavity_set_voltage)(   cavity, ( NS(be_cavity_real_t) )0 );
    NS(Cavity_set_frequency)( cavity, ( NS(be_cavity_real_t) )0 );
    NS(Cavity_set_lag)(       cavity, ( NS(be_cavity_real_t) )0 );
...
#endif /* SIXTRACKLIB_COMMON_BEAM_ELEMENTS_CAVITY_CAVITY_API_C99_H__ */
/* end: */
