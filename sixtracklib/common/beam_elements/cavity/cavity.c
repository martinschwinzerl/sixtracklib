...
SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)* NS(Cavity_from_cbuffer_ext)(
...
SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)* NS(Cavity_cbuffer_new_ext)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer ) {
    return NS(Cavity_cbuffer_new)( buffer ); }

SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)* NS(Cavity_cbuffer_add_ext)(
...
SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(Cavity)* NS(Cavity_cbuffer_add_copy_ext)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
