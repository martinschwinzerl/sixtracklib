...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(Monitor) const*
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_DATAPTR_DEC NS(Monitor)*
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_BE_ARGPTR_DEC NS(Monitor) const*
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Monitor)* NS(Monitor_from_cbuffer)(
...
SIXTRL_INLINE SIXTRL_CBUFFER_DATAPTR_DEC NS(Monitor)*
NS(Monitor_cobj_flat_buffer_new)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Monitor)* NS(Monitor_cbuffer_new)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer ) {
    SIXTRL_BE_ARGPTR_DEC NS(Monitor) elem;
    NS(Monitor_clear)( &elem );
    return NS(Monitor_cbuffer_add_copy)( buffer, &elem ); }

SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Monitor)* NS(Monitor_cbuffer_add)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
    NS(particle_index_type) const num_stores,
    NS(particle_index_type) const start, NS(particle_index_type) const skip,
    NS(particle_index_type) const min_particle_id,
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Monitor)* NS(Monitor_cbuffer_add_copy)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
    SIXTRL_BE_ARGPTR_DEC const NS(Monitor) *const SIXTRL_RESTRICT orig ) {
