...
SIXTRL_BE_ARGPTR_DEC NS(SRotation) const* NS(SRotation_const_from_cbuffer)(
    SIXTRL_CBUFFER_ARGPTR_DEC const struct NS(CBuffer) *const SIXTRL_RESTRICT b,
    NS(cobj_size_type) const idx ) SIXTRL_NOEXCEPT;

SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(SRotation)* NS(SRotation_from_cbuffer)(
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_DATAPTR_DEC NS(SRotation)*
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(SRotation)* NS(SRotation_cbuffer_new)(
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_BE_ARGPTR_DEC NS(SRotation) const*
...
NS(SRotation_const_from_cobj_index)(
    ...
    return ( NS(CObjIndex_is_srotation)( obj ) )
        ? ( SIXTRL_BE_ARGPTR_DEC NS(SRotation) const* )(
            uintptr_t )NS(CObjIndex_begin_addr)( obj )
        : SIXTRL_NULLPTR; }

SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(SRotation)* NS(SRotation_from_cobj_index)(
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(SRotation)* NS(SRotation_from_cbuffer)(
...
SIXTRL_INLINE SIXTRL_CBUFFER_DATAPTR_DEC NS(SRotation)*
NS(SRotation_cobj_flat_buffer_new)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
NS(SRotation_cobj_flat_buffer_add_copy)(
    ...
    return ( SIXTRL_CBUFFER_DATAPTR_DEC NS(SRotation)* )( uintptr_t
        )NS(CObjIndex_begin_addr)( NS(CObjFlatBuffer_add_copy_of_trivial_object)(
            buffer, slot_size, orig, NS(SRotation_cobj_reserved_handle_size)(
                slot_size ), NS(SRotation_cobj_type_id)(), false ) ); }
...
NS(SRotation_cbuffer_add_copy)(
    ...
    return ( SIXTRL_BE_ARGPTR_DEC NS(SRotation)* )( uintptr_t
            ...
            buffer, orig, NS(SRotation_cobj_reserved_handle_size)(
                NS(CBuffer_slot_size)( buffer ) ), NS(SRotation_cobj_type_id)(),
                    false ) ); }
