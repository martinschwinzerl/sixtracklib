...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_from_cbuffer)(
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_DATAPTR_DEC NS(Drift)*
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_cbuffer_new)(
    SIXTRL_CBUFFER_ARGPTR_DEC struct NS(CBuffer)* SIXTRL_RESTRICT buffer );

SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_cbuffer_add)(
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_BE_ARGPTR_DEC NS(Drift) const*
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_from_cobj_index)(
    ...
    return ( SIXTRL_BE_ARGPTR_DEC NS(Drift)* )NS(Drift_const_from_cobj_index)(
        obj ); }
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_from_cobj_flat_buffer)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const idx, NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_from_cbuffer)(
...
SIXTRL_INLINE SIXTRL_CBUFFER_DATAPTR_DEC NS(Drift)*
NS(Drift_cobj_flat_buffer_new)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_cbuffer_new)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer ) {
    SIXTRL_BE_ARGPTR_DEC NS(Drift) elem;
    NS(Drift_clear)( &elem );
    return NS(Drift_cbuffer_add_copy)( buffer, &elem ); }

SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(Drift)* NS(Drift_cbuffer_add)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
    NS(be_real_type) const length ) {
    SIXTRL_BE_ARGPTR_DEC NS(Drift) elem;
    NS(Drift_init)( &elem, length );
...
NS(Drift_cbuffer_add_copy)(
    ...
    return ( SIXTRL_BE_ARGPTR_DEC NS(Drift)* )( uintptr_t
            ...
            buffer, orig, NS(Drift_cobj_reserved_handle_size)(
                NS(CBuffer_slot_size)( buffer ) ), NS(Drift_cobj_type_id)(),
                    false ) ); }
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(DriftExact)* NS(DriftExact_from_cbuffer)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
    NS(size_type) const idx ) SIXTRL_NOEXCEPT {
    return NS(DriftExact_from_cobj_index)(
...
SIXTRL_INLINE SIXTRL_CBUFFER_DATAPTR_DEC NS(DriftExact)*
NS(DriftExact_cobj_flat_buffer_new)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(DriftExact)* NS(DriftExact_cbuffer_new)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer ) {
    SIXTRL_BE_ARGPTR_DEC NS(DriftExact) elem;
    NS(DriftExact_clear)( &elem );
    return NS(DriftExact_cbuffer_add_copy)( buffer, &elem ); }

SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(DriftExact)* NS(DriftExact_cbuffer_add)(
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT buffer,
    NS(be_real_type) const length ) {
    SIXTRL_BE_ARGPTR_DEC NS(DriftExact) elem;
    NS(DriftExact_init)( &elem, length );
...
NS(DriftExact_cbuffer_add_copy)(
    ...
    return ( SIXTRL_BE_ARGPTR_DEC NS(DriftExact)* )( uintptr_t
            ...
            buffer, orig, NS(DriftExact_cobj_reserved_handle_size)(
                NS(CBuffer_slot_size)( buffer ) ), NS(DriftExact_cobj_type_id)(),
                    false ) ); }
