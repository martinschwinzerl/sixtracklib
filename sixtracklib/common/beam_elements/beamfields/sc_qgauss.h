...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(SCQGaussProfile) const*
...
/* ************************************************************************* */
    ...
    #include "sixtracklib/common/beam_elements/beamfields/sc_qgauss_cobj.h"
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(SCQGaussProfile) const*
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(SCQGaussProfile)* NS(SCQGaussProfile_from_cobj_index)(
    SIXTRL_CBUFFER_OBJ_ARGPTR_DEC NS(CObjIndex)* obj ) SIXTRL_NOEXCEPT {
    return ( SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(SCQGaussProfile)*
