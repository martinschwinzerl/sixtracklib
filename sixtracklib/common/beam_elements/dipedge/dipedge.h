...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(DipoleEdge) const*
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(DipoleEdge) const*
...
/* ========================================================================= */
    ...
    #include "sixtracklib/common/beam_elements/dipedge/dipedge_cobj.h"
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(DipoleEdge) const*
...
NS(DipoleEdge_from_cobj_index)( SIXTRL_CBUFFER_OBJ_ARGPTR_DEC NS(CObjIndex)* obj
    ) SIXTRL_NOEXCEPT { return ( SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(DipoleEdge)*
