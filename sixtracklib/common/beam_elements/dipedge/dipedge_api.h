#ifndef SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DIPEDGE_DIPEDGE_API_C99_H__
#define SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DIPEDGE_DIPEDGE_API_C99_H__
...
SIXTRL_STATIC SIXTRL_FN NS(be_dipedge_real_t) NS(DipoleEdge_get_r21)(
    SIXTRL_BE_ARGPTR_DEC const NS(DipoleEdge) *const SIXTRL_RESTRICT dipedge );

SIXTRL_STATIC SIXTRL_FN NS(be_dipedge_real_t) NS(DipoleEdge_get_r43)(
    SIXTRL_BE_ARGPTR_DEC const NS(DipoleEdge) *const SIXTRL_RESTRICT dipedge );
...
SIXTRL_STATIC SIXTRL_FN void NS(DipoleEdge_set_r21)(
    SIXTRL_BE_ARGPTR_DEC NS(DipoleEdge)* SIXTRL_RESTRICT dipedge,
    NS(be_dipedge_real_t) const r21  );

SIXTRL_STATIC SIXTRL_FN void NS(DipoleEdge_set_r43)(
    SIXTRL_BE_ARGPTR_DEC NS(DipoleEdge)* SIXTRL_RESTRICT dipedge,
    NS(be_dipedge_real_t) const r43 );
...
SIXTRL_BUFFER_DATAPTR_DEC NS(DipoleEdge)* NS(DipoleEdge_add)(
    SIXTRL_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer,
    NS(be_dipedge_real_t) const r21, NS(be_dipedge_real_t) const r43 );
...
SIXTRL_INLINE void NS(DipoleEdge_clear)(
    SIXTRL_BE_ARGPTR_DEC NS(DipoleEdge)* SIXTRL_RESTRICT dipedge )
{
    SIXTRL_STATIC_VAR NS(be_dipedge_real_t) const ZERO = ( NS(be_dipedge_real_t) )0;
    SIXTRL_STATIC_VAR NS(be_dipedge_real_t) const ONE  = ( NS(be_dipedge_real_t) )1;
...
SIXTRL_INLINE NS(be_dipedge_real_t) NS(DipoleEdge_get_r21)(
    SIXTRL_BE_ARGPTR_DEC const NS(DipoleEdge) *const SIXTRL_RESTRICT dipedge )
{
...
SIXTRL_INLINE NS(be_dipedge_real_t) NS(DipoleEdge_get_r43)(
    SIXTRL_BE_ARGPTR_DEC const NS(DipoleEdge) *const SIXTRL_RESTRICT dipedge )
{
    SIXTRL_ASSERT( dipedge != SIXTRL_NULLPTR );
    return dipedge->r43;
...
#endif /* SIXTRACKLIB_COMMON_BEAM_ELEMENTS_DIPEDGE_DIPEDGE_API_C99_H__ */
/* end: */
