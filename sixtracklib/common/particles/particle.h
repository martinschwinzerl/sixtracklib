...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_DATAPTR_DEC NS(Particle) const*
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_DATAPTR_DEC NS(Particle)*
...
SIXTRL_EXTERN SIXTRL_HOST_FN SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle) const*
...
NS(Particle_const_from_cobj_index)( SIXTRL_CBUFFER_OBJ_ARGPTR_DEC const
    ...
    SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle) const* elem = SIXTRL_NULLPTR;
    if( NS(CObjIndex_is_particle)( obj ) ) {
        elem = ( SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle) const* )(
...
NS(Particle_from_cobj_index)( SIXTRL_CBUFFER_OBJ_ARGPTR_DEC NS(CObjIndex)*
    SIXTRL_RESTRICT obj ) SIXTRL_NOEXCEPT {
    return ( SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle)*
...
SIXTRL_INLINE SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle)* NS(Particle_from_cbuffer)(
...
SIXTRL_INLINE SIXTRL_CBUFFER_DATAPTR_DEC NS(Particle)*
NS(Particle_cobj_flat_buffer_new)(
    SIXTRL_CBUFFER_DATAPTR_DEC unsigned char* SIXTRL_RESTRICT buffer,
    NS(size_type) const slot_size ) SIXTRL_NOEXCEPT {
...
SIXTRL_INLINE SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle)* NS(Particle_cbuffer_new)(
...
SIXTRL_INLINE SIXTRL_PARTICLE_ARGPTR_DEC NS(Particle)* NS(Particle_cbuffer_add)(
