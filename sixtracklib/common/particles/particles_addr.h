...
SIXTRL_STATIC SIXTRL_FN SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(ParticlesAddr) const*
...
/* ************************************************************************* */
    ...
    #include "sixtracklib/common/particles/particles_addr_cobj.h"
...
SIXTRL_INLINE SIXTRL_CBUFFER_OBJ_DATAPTR_DEC NS(ParticlesAddr) const*
NS(ParticlesAddr_const_from_cobj_index)( SIXTRL_CBUFFER_OBJ_ARGPTR_DEC
    const struct NS(CObjIndex) *const SIXTRL_RESTRICT obj ) SIXTRL_NOEXCEPT {
