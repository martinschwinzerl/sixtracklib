...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    {
        static constexpr bool is_particle = true;
    };

    template< class R, class I, arch_size_t N,
              arch_size_t RAlign, arch_size_t IAlign >
    constexpr bool ObjDataParticleTraits<
        TParticle< R, I, N, RAlign, IAlign > >::is_particle;
    ...
    template< class R, class I, arch_size_t N,
              arch_size_t RAlign, arch_size_t IAlign >
    constexpr arch_size_t ParticleTraits< TParticle<
        R, I, N, RAlign, IAlign > >::real_alignment;

    template< class R, class I, arch_size_t N,
              arch_size_t RAlign, arch_size_t IAlign >
    constexpr arch_size_t ParticleTraits< TParticle<
        R, I, N, RAlign, IAlign > >::index_alignment;

    template< class R, class I, arch_size_t N,
              arch_size_t RAlign, arch_size_t IAlign >
    constexpr particle_num_elements_t ParticleTraits< TParticle<
        R, I, N, RAlign, IAlign > >::num_particles;
