...
NS(status_type) NS(Track_testlib_elem_by_elem_cbuffer_ext)(
...
{
    return NS(Track_testlib_elem_by_elem_cbuffer)( track_pbuffer, cmp_pbuffer,
        lattice_buffer, diff_buffer, config );
}
