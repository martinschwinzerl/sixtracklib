#ifndef SIXTRACKLIB_TESTLIB_COMMON_TRACK_SIXTRACK_SEQU_BY_SEQU_TRACKING_H__
#define SIXTRACKLIB_TESTLIB_COMMON_TRACK_SIXTRACK_SEQU_BY_SEQU_TRACKING_H__
...
SIXTRL_STATIC SIXTRL_FN NS(status_type) NS(Track_sixtrack_sequ_by_sequ_cbuffer)(
    ...
    SIXTRL_CBUFFER_ARGPTR_DEC const NS(CBuffer)
        *const SIXTRL_RESTRICT cmp_pbuffer,
    SIXTRL_CBUFFER_ARGPTR_DEC const NS(CBuffer)
        *const SIXTRL_RESTRICT lattice_buffer,
        ...
        for( ; ii < NUM_SEQUENCES ; ++ii )
        {
            ...
            SIXTRL_PARTICLES_ARGPTR_DEC NS(Particles)* pset_diff =
                ...
                ? NS(Particles_cobj_flat_buffer_new)(
                    diff_buffer, slot_size, NUM_PARTICLES )
                : SIXTRL_NULLPTR;
...
SIXTRL_INLINE NS(status_type) NS(Track_sixtrack_sequ_by_sequ_cbuffer)(
    ...
    SIXTRL_CBUFFER_ARGPTR_DEC const NS(CBuffer) *const
        SIXTRL_RESTRICT lattice_buffer,
    SIXTRL_CBUFFER_ARGPTR_DEC NS(CBuffer)* SIXTRL_RESTRICT diff_buffer,
    SIXTRL_TRACK_ARGPTR_DEC const NS(TrackConfig) *const SIXTRL_RESTRICT config
) {
    NS(status_type) status = ( NS(status_type) )SIXTRL_STATUS_GENERAL_FAILURE;
...
#endif /* !defined( _GPUCODE ) && defined( __cplusplus ) */
#endif /* SIXTRACKLIB_TESTLIB_COMMON_TRACK_SIXTRACK_SEQU_BY_SEQU_TRACKING_H__ */
