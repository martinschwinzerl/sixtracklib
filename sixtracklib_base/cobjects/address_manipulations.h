#ifndef SIXTRACKLIB_BASE_COBJECTS_ADDR_MANIPULATIONS_H__
#define SIXTRACKLIB_BASE_COBJECTS_ADDR_MANIPULATIONS_H__
...
#endif /* !defined( _GPUCODE ) && defined( __cplusplus ) */
#endif /* SIXTRACKLIB_BASE_COBJECTS_ADDR_MANIPULATIONS_H__ */
