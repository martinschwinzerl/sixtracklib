#ifndef SIXTRACKLIB_BASE_INTERNAL_OBJ_STORE_TRAITS_H__
#define SIXTRACKLIB_BASE_INTERNAL_OBJ_STORE_TRAITS_H__
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    ObjData_can_be_memcopied() SIXTRL_NOEXCEPT
    {
    ...
    {
        SIXTRL_STATIC SIXTRL_FN void preset( SIXTRL_ARGPTR_DEC E*
            SIXTRL_RESTRICT SIXTRL_UNUSED( obj ) ) SIXTRL_NOEXCEPT
        {
            return;
        }

        template< typename... Args >
        SIXTRL_STATIC SIXTRL_FN constexpr SIXTRL_CXX_NAMESPACE::status_t init(
            SIXTRL_ARGPTR_DEC E* SIXTRL_RESTRICT SIXTRL_UNUSED( obj ),
            Args&&... SIXTRL_UNUSED( args ) ) SIXTRL_NOEXCEPT
        {
...
#endif /* SIXTRACKLIB_BASE_INTERNAL_OBJ_STORE_TRAITS_H__ */
