#ifndef SIXTRACKLIB_BASE_INTERNAL_COBJ_CONVERT_H__
#define SIXTRACKLIB_BASE_INTERNAL_COBJ_CONVERT_H__
...
namespace SIXTRL_CXX_NAMESPACE
{
    ...
    SIXTRL_BASE_EXPORT_API constexpr bool
    ObjDataConversionTypesRequireNoPrepareTraits< SrcT, DstT,
    ...
    struct ObjDataConverter
    {
        ...
        SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN SIXTRL_CXX_NAMESPACE::status_t
        ...
        SIXTRL_CXX_NAMESPACE::status_t attempt_conversion(
        ...
        template< typename... Args >
        SIXTRL_STATIC SIXTRL_INLINE SIXTRL_FN
        SIXTRL_CXX_NAMESPACE::status_t perform(
            ...
            Args&&... conv_paramters ) SIXTRL_NOEXCEPT
        {
            ...
            st::status_t status = this_t::attempt_conversion(
    ...
    template< class E, SIXTRL_CXX_NAMESPACE::store_backend_t SrcStoreT =
    ...
    ObjData_allow_type_copy() SIXTRL_NOEXCEPT
    {
...
#endif /* C++ */
#endif /* SIXTRACKLIB_BASE_INTERNAL_COBJ_CONVERT_H__ */
