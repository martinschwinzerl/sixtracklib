#ifndef SIXTRACKLIB_BASE_INTERNAL_THREAD_SCOPED_LOCK_H__
#define SIXTRACKLIB_BASE_INTERNAL_THREAD_SCOPED_LOCK_H__
...
{
    class SIXTRL_BASE_EXPORT_API ThreadLockable
    {
        public:
    ...
    class SIXTRL_BASE_EXPORT_API ThreadUniqueLock
    {
        public:
...
struct NS(ThreadLockable);
typedef struct NS(ThreadLockable) NS(ThreadLockable);

struct NS(ThreadUniqueLock);
typedef struct NS(ThreadUniqueLock) NS(ThreadUniqueLock);
...
SIXTRL_BASE_EXPORT_API SIXTRL_HOST_FN NS(ThreadLockable)*
NS(TheadLockable_create)( void );

SIXTRL_BASE_EXPORT_API SIXTRL_HOST_FN void NS(TheadLockable_delete)(
    NS(ThreadLockable)* SIXTRL_RESTRICT );

/* ------------------------------------------------------------------------- */

SIXTRL_BASE_EXPORT_API SIXTRL_HOST_FN NS(ThreadUniqueLock)*
NS(TheadUniqueLock_create)( NS(ThreadLockable)* SIXTRL_RESTRICT lockable );

SIXTRL_BASE_EXPORT_API SIXTRL_HOST_FN void NS(TheadUniqueLock_delete)(
...
#endif /* SIXTRACKLIB_BASE_INTERNAL_THREAD_SCOPED_LOCK_H__ */
