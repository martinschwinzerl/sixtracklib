#ifndef SIXTRACKLIB_BASE_INTERNAL_OBJ_ILLEGAL_TYPE_H__
#define SIXTRACKLIB_BASE_INTERNAL_OBJ_ILLEGAL_TYPE_H__
...
#endif /* SIXTRACKLIB_BASE_INTERNAL_OBJ_ILLEGAL_TYPE_H__ */
