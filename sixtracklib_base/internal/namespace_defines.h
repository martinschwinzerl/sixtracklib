#ifndef SIXTRACKLIB_BASE_INTERNAL_NAMESPACE_DEFINES_H__
#define SIXTRACKLIB_BASE_INTERNAL_NAMESPACE_DEFINES_H__
...
#endif /* SIXTRACKLIB_BASE_INTERNAL_NAMESPACE_DEFINES_H__ */
