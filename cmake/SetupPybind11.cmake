if( NOT SIXTRACKLIB_CMAKE_SETUP_PYBIND11_FINISHED )
   set( SIXTRACKLIB_CMAKE_SETUP_PYBIND11_FINISHED 1 )
    message( STATUS "---- processing cmake/SetupPybind11.cmake" )
    find_package( Python COMPONENTS Interpreter Development REQUIRED )
    find_package( pybind11 QUIET )

    if( ( NOT pybind11_FOUND ) AND
        ( NOT SIXTRACKL_REQUIRE_OFFLINE_BUILD ) )
