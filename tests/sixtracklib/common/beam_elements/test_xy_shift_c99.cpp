...
TEST( C99CommonBeamElementsXYShift, CobjectsStoreAndRestore )
{
    namespace st = SIXTRL_CXX_NAMESPACE;

    using size_type   = ::NS(cobj_size_type);
    using elem_type  =  ::NS(XYShift);
    ...
    ASSERT_TRUE( st::CObjects_type_id< elem_type >() ==
                 st::COBJECTS_TYPE_ID_XY_SHIFT );
    ASSERT_TRUE( st::CObjects_is_trivial_type< elem_type >() );
    ASSERT_TRUE( st::CObjects_num_pointers< elem_type >() == size_type{ 0 } );

    ASSERT_TRUE( ::NS(XYShift_cobj_num_dataptrs)() == size_type{ 0 } );
    ASSERT_TRUE( ::NS(XYShift_cobj_type_id)() == ::NS(COBJECTS_TYPE_ID_XY_SHIFT) );
    ...
    std::uniform_real_distribution< real_type > dx_dist(
        real_type{ -1.0 }, real_type{ 1.0 } );

    std::uniform_real_distribution< real_type > dy_dist(
        real_type{ -1.0 }, real_type{ 1.0 } );
    ...
    size_type const n_ptrs = ::NS(XYShift_cobj_num_dataptrs)() * NUM_BELEMENTS;

    std::vector< elem_type > CMP_ELEMENTS( NUM_BELEMENTS, elem_type{} );
    for( auto& e : CMP_ELEMENTS )
    {
        ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_init)( &e,
            dx_dist( prng ), dy_dist( prng ) ) );
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        ...
        SIXTRL_ASSERT( ::NS(XYShift_cobj_num_dataptrs)() < TEMP_NN );
        ...
        switch( flat_buffer_mode )
        {
            case 0:
            {
                flat_buffer_obj = ::NS(XYShift_cobj_flat_buffer_new)(
                    flat_buffer, slot_size );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dx)(
                    flat_buffer_obj, ::NS(XYShift_dx)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dy)(
                    flat_buffer_obj, ::NS(XYShift_dy)( cmp_obj ) ) );
            ...
            case 1:
            {
                ...
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_copy)(
            ...
            case 2:
            {
                flat_buffer_obj = ::NS(XYShift_cobj_flat_buffer_add)(
                    flat_buffer, slot_size, ::NS(XYShift_dx)( cmp_obj ),
                        ::NS(XYShift_dy)( cmp_obj ) );
            ...
            case 3:
            {
                flat_buffer_obj = ::NS(XYShift_cobj_flat_buffer_add_copy)(
            ...
            case 5:
            {
                flat_buffer_obj = ::NS(XYShift_from_cobj_index)(
                    ::NS(CObjFlatBuffer_add_copy_of_object)(
                        flat_buffer, slot_size, cmp_obj,
                        ::NS(XYShift_cobj_reserved_handle_size)( slot_size ),
                        ::NS(XYShift_cobj_type_id)(),
                        ::NS(XYShift_cobj_num_dataptrs)(),
            ...
            case 6:
            {
                flat_buffer_obj = ::NS(XYShift_from_cobj_index)(
                    ::NS(CObjFlatBuffer_add_copy_of_object_detailed)(
                        flat_buffer, slot_size, cmp_obj,
                        ::NS(XYShift_cobj_reserved_handle_size)( slot_size ),
                        ::NS(XYShift_cobj_actual_handle_size)( slot_size ),
                        ::NS(XYShift_cobj_type_id)(),
                        ::NS(XYShift_cobj_num_dataptrs)(),
                        &OFFSETS[ 0 ], &SIZES[ 0 ], &COUNTS[ 0 ], true ) );
        ...
        ASSERT_TRUE( 0 == ::NS(XYShift_compare)( cmp_obj, flat_buffer_obj ) );
        ...
        switch( c99_buffer_mode )
        {
            case 0:
            {
                c99_buffer_obj = ::NS(XYShift_cbuffer_new)( c99_buffer );
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dx)(
                    c99_buffer_obj, ::NS(XYShift_dx)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dy)(
                    c99_buffer_obj, ::NS(XYShift_dy)( cmp_obj ) ) );
            ...
            case 2:
            {
                c99_buffer_obj = ::NS(XYShift_cbuffer_add)(
                    c99_buffer, ::NS(XYShift_dx)( cmp_obj ),
                        ::NS(XYShift_dy)( cmp_obj ) );
                break;
            }
            ...
            case 3:
            {
                c99_buffer_obj = ::NS(XYShift_cbuffer_add_copy)(
                    c99_buffer, cmp_obj );
                break;
            }
            ...
            case 4:
            {
                c99_buffer_obj = ::NS(XYShift_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(XYShift_compare)( cmp_obj, c99_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(XYShift_compare)(
        ...
        switch( cxx_buffer_mode )
        {
            case 0:
            {
                cxx_buffer_obj = ::NS(XYShift_cbuffer_new)( cxx_buffer.as_c_api() );
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dx)(
                    cxx_buffer_obj, ::NS(XYShift_dx)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_set_dy)(
                    cxx_buffer_obj, ::NS(XYShift_dy)( cmp_obj ) ) );
            ...
            case 2:
            {
                cxx_buffer_obj = ::NS(XYShift_cbuffer_add)(
                    cxx_buffer.as_c_api(),  ::NS(XYShift_dx)( cmp_obj ),
                        ::NS(XYShift_dy)( cmp_obj ) );
                break;
            }
            ...
            case 3:
            {
                cxx_buffer_obj = ::NS(XYShift_cbuffer_add_copy)(
            ...
            case 4:
            {
                cxx_buffer_obj = ::NS(XYShift_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(XYShift_compare)( cmp_obj, cxx_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(XYShift_compare)(
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        auto c99_buffer_obj = ::NS(XYShift_const_from_cbuffer)( c99_buffer, ii );
        auto cxx_buffer_obj = cxx_buffer.get_object< elem_type >( ii );
        auto flat_buffer_obj = ::NS(XYShift_const_from_cobj_flat_buffer)(
        ...
        ASSERT_TRUE( cxx_buffer_obj  == ::NS(XYShift_const_from_cbuffer)(
    ...
    real_type const saved_dx = ::NS(XYShift_dx)( flat_buffer_obj );

    do
    {
        ASSERT_TRUE( ::NS(XYShift_set_dx)(
            ::NS(XYShift_from_cobj_flat_buffer)( flat_buffer, 0, slot_size ),
                dx_dist( prng ) ) == st::STATUS_SUCCESS );
    }
    while( 0 == ::NS(Type_value_comp_result)( saved_dx,
           ::NS(XYShift_dx)( flat_buffer_obj ) ) );

    ASSERT_TRUE( 0 != ::NS(XYShift_compare)(
        &CMP_ELEMENTS[ 0 ], flat_buffer_obj ) );

    ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(XYShift_copy)(
        ::NS(XYShift_from_cobj_flat_buffer)( flat_buffer, 0u, slot_size ),
            &CMP_ELEMENTS[ 0 ] ) );
