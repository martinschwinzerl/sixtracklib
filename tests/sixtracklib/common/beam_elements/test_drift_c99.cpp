...
TEST( C99CommonBeamElementsDrift, CobjectsStoreAndRestore )
{
    namespace st = SIXTRL_CXX_NAMESPACE;

    using size_type   = ::NS(cobj_size_type);
    using drift_type  = ::NS(Drift);
    ...
    ASSERT_TRUE( st::CObjects_type_id< drift_type >() ==
                 st::COBJECTS_TYPE_ID_DRIFT );
    ASSERT_TRUE( st::CObjects_is_trivial_type< drift_type >() );
    ASSERT_TRUE( st::CObjects_num_pointers< drift_type >() == size_type{ 0 } );

    ASSERT_TRUE( ::NS(Drift_cobj_num_dataptrs)() == size_type{ 0 } );
    ASSERT_TRUE( ::NS(Drift_cobj_type_id)() == ::NS(COBJECTS_TYPE_ID_DRIFT) );
    ...
    size_type const n_ptrs = ::NS(Drift_cobj_num_dataptrs)() * NUM_BELEMENTS;

    std::vector< drift_type > CMP_ELEMENTS( NUM_BELEMENTS, drift_type{} );
    for( auto& e : CMP_ELEMENTS )
    {
        ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_set_length)(
            &e, length_dist( prng ) ) );
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        ...
        SIXTRL_ASSERT( ::NS(Drift_cobj_num_dataptrs)() < TEMP_NN );
        ...
        switch( flat_buffer_mode )
        {
            case 0:
            {
                flat_buffer_obj = ::NS(Drift_cobj_flat_buffer_new)(
                    flat_buffer, slot_size );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_set_length)(
                    flat_buffer_obj, ::NS(Drift_length)( cmp_obj ) ) );
            ...
            case 1:
            {
                ...
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_copy)(
            ...
            case 2:
            {
                flat_buffer_obj = ::NS(Drift_cobj_flat_buffer_add)(
                    flat_buffer, slot_size, ::NS(Drift_length)( cmp_obj ) );
            ...
            case 3:
            {
                flat_buffer_obj = ::NS(Drift_cobj_flat_buffer_add_copy)(
            ...
            case 4:
            {
                flat_buffer_obj = ::NS(Drift_from_cobj_index)(
                    ::NS(CObjFlatBuffer_add_copy_of_trivial_object)(
                        flat_buffer, slot_size, cmp_obj,
                        ::NS(Drift_cobj_reserved_handle_size)( slot_size ),
                        ::NS(Drift_cobj_type_id)(), true ) );
            ...
            case 5:
            {
                flat_buffer_obj = ::NS(Drift_from_cobj_index)(
                    ::NS(CObjFlatBuffer_add_copy_of_object)(
                        flat_buffer, slot_size, cmp_obj,
                        ::NS(Drift_cobj_reserved_handle_size)( slot_size ),
                        ::NS(Drift_cobj_type_id)(),
                        ::NS(Drift_cobj_num_dataptrs)(),
        ...
        ASSERT_TRUE( 0 == ::NS(Drift_compare)( cmp_obj, flat_buffer_obj ) );
        ...
        switch( c99_buffer_mode )
        {
            case 0:
            {
                c99_buffer_obj = ::NS(Drift_cbuffer_new)( c99_buffer );
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_set_length)(
                    c99_buffer_obj, ::NS(Drift_length)( cmp_obj ) ) );
                break;
            }
            ...
            case 2:
            {
                c99_buffer_obj = ::NS(Drift_cbuffer_add)(
                    c99_buffer, ::NS(Drift_length)( cmp_obj ) );
                break;
            }

            case 3:
            {
                c99_buffer_obj = ::NS(Drift_cbuffer_add_copy)(
                    c99_buffer, cmp_obj );
                break;
            }
            ...
            case 4:
            {
                c99_buffer_obj = ::NS(Drift_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(Drift_compare)( cmp_obj, c99_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(Drift_compare)(
        ...
        switch( cxx_buffer_mode )
        {
            case 0:
            {
                cxx_buffer_obj = ::NS(Drift_cbuffer_new)( cxx_buffer.as_c_api() );
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_set_length)(
                    cxx_buffer_obj, ::NS(Drift_length)( cmp_obj ) ) );
                break;
            }
            ...
            case 2:
            {
                cxx_buffer_obj = ::NS(Drift_cbuffer_add)(
                    cxx_buffer.as_c_api(), ::NS(Drift_length)( cmp_obj ) );
                break;
            }

            case 3:
            {
                cxx_buffer_obj = ::NS(Drift_cbuffer_add_copy)(
            ...
            case 4:
            {
                cxx_buffer_obj = ::NS(Drift_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(Drift_compare)( cmp_obj, cxx_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(Drift_compare)(
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        auto c99_buffer_obj = ::NS(Drift_const_from_cbuffer)( c99_buffer, ii );
        auto cxx_buffer_obj = cxx_buffer.get_object< drift_type >( ii );
        auto flat_buffer_obj = ::NS(Drift_const_from_cobj_flat_buffer)(
        ...
        ASSERT_TRUE( cxx_buffer_obj  == ::NS(Drift_const_from_cbuffer)(
    ...
    real_type const saved_length = ::NS(Drift_length)( flat_buffer_obj );

    do
    {
        ASSERT_TRUE( ::NS(Drift_set_length)(
            ::NS(Drift_from_cobj_flat_buffer)( flat_buffer, 0, slot_size ),
                length_dist( prng ) ) == st::STATUS_SUCCESS );
    }
    while( 0 == ::NS(Type_value_comp_result)( saved_length,
           ::NS(Drift_length)( flat_buffer_obj ) ) );

    ASSERT_TRUE( 0 != ::NS(Drift_compare)(
        &CMP_ELEMENTS[ 0 ], flat_buffer_obj ) );

    ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(Drift_copy)(
        ::NS(Drift_from_cobj_flat_buffer)( flat_buffer, 0u, slot_size ),
            &CMP_ELEMENTS[ 0 ] ) );
