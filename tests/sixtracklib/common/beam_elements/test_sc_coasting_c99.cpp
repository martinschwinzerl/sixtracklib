...
TEST( C99CommonBeamElementsSCCoasting, CobjectsStoreAndRestore )
{
    ...
    ASSERT_TRUE( st::CObjects_type_id< elem_type >() ==
                 st::COBJECTS_TYPE_ID_SC_COASTING );
    ASSERT_TRUE( st::CObjects_is_trivial_type< elem_type >() );
    ASSERT_TRUE( st::CObjects_num_pointers< elem_type >() == size_type{ 0 } );

    ASSERT_TRUE( ::NS(SCCoasting_cobj_num_dataptrs)() == size_type{ 0 } );
    ASSERT_TRUE( ::NS(SCCoasting_cobj_type_id)() ==
                 ::NS(COBJECTS_TYPE_ID_SC_COASTING) );
    ...
    std::uniform_real_distribution< real_type > circumference_dist(
    ...
    size_type const n_ptrs = NUM_BELEMENTS *
        ::NS(SCCoasting_cobj_num_dataptrs)();

    std::vector< elem_type > CMP_ELEMENTS( NUM_BELEMENTS, elem_type{} );
    for( auto& e : CMP_ELEMENTS )
    {
        ASSERT_TRUE( st::STATUS_SUCCESS == st::testlib::SCCoasting_init_random(
            &e, prng, num_particles_dist, circumference_dist, sigma_xy_dist,
            sigma_xy_dist, sigma_x_equals_y_dist, SIGMA_X_EQUALS_Y_THRESHOLD,
            length_dist, xy_co_dist, xy_co_dist, min_sigma_diff_dist,
            is_enabled_dist, IS_ENABLED_THRESHOLD ) );

        n_slots += ::NS(SCCoasting_cobj_required_num_bytes)(
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        ...
        SIXTRL_ASSERT( ::NS(SCCoasting_cobj_num_dataptrs)() < TEMP_NN );
        ...
        switch( flat_buffer_mode )
        {
            case 0:
            {
                flat_buffer_obj = ::NS(SCCoasting_cobj_flat_buffer_new)(
                    flat_buffer, slot_size );

                ASSERT_TRUE( flat_buffer_obj != nullptr );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_number_of_particles)( flat_buffer_obj,
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_circumference)( flat_buffer_obj,
                        ::NS(SCCoasting_circumference)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_x)(
                    flat_buffer_obj, ::NS(SCCoasting_sigma_x)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_y)(
                    flat_buffer_obj, ::NS(SCCoasting_sigma_y)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_length)(
                    flat_buffer_obj, ::NS(SCCoasting_length)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_x_co)(
                    flat_buffer_obj, ::NS(SCCoasting_x_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_y_co)(
                    flat_buffer_obj, ::NS(SCCoasting_y_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_min_sigma_diff)( flat_buffer_obj,
                        ::NS(SCCoasting_min_sigma_diff)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_enabled)( flat_buffer_obj,
                        ::NS(SCCoasting_enabled)( cmp_obj ) ) );
            ...
            case 1:
            {
                ...
                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_copy)(
            ...
            case 2:
            {
                flat_buffer_obj = ::NS(SCCoasting_cobj_flat_buffer_add)(
                    flat_buffer, slot_size,
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ),
                        ::NS(SCCoasting_circumference)( cmp_obj ),
                        ::NS(SCCoasting_sigma_x)( cmp_obj ),
                        ::NS(SCCoasting_sigma_y)( cmp_obj ),
                        ::NS(SCCoasting_length)( cmp_obj ),
                        ::NS(SCCoasting_x_co)( cmp_obj ),
                        ::NS(SCCoasting_y_co)( cmp_obj ),
                        ::NS(SCCoasting_min_sigma_diff)( cmp_obj ),
                        ::NS(SCCoasting_enabled)( cmp_obj )  );
            ...
            case 3:
            {
                flat_buffer_obj = ::NS(SCCoasting_cobj_flat_buffer_add_copy)(
            ...
            case 6:
            {
                flat_buffer_obj = ::NS(SCCoasting_from_cobj_index)(
                    ::NS(CObjFlatBuffer_add_copy_of_object_detailed)(
                        flat_buffer, slot_size, cmp_obj,
                        ::NS(SCCoasting_cobj_reserved_handle_size)( slot_size ),
                        ::NS(SCCoasting_cobj_actual_handle_size)( slot_size ),
                        ::NS(SCCoasting_cobj_type_id)(),
                        ::NS(SCCoasting_cobj_num_dataptrs)(),
                        &OFFSETS[ 0 ], &SIZES[ 0 ], &COUNTS[ 0 ], true ) );
        ...
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)(
        ...
        switch( c99_buffer_mode )
        {
            case 0:
            {
                c99_buffer_obj = ::NS(SCCoasting_cbuffer_new)( c99_buffer );

                ASSERT_TRUE( c99_buffer_obj != nullptr );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_number_of_particles)( c99_buffer_obj,
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_circumference)( c99_buffer_obj,
                        ::NS(SCCoasting_circumference)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_x)(
                    c99_buffer_obj, ::NS(SCCoasting_sigma_x)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_y)(
                    c99_buffer_obj, ::NS(SCCoasting_sigma_y)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_length)(
                    c99_buffer_obj, ::NS(SCCoasting_length)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_x_co)(
                    c99_buffer_obj, ::NS(SCCoasting_x_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_y_co)(
                    c99_buffer_obj, ::NS(SCCoasting_y_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_min_sigma_diff)( c99_buffer_obj,
                        ::NS(SCCoasting_min_sigma_diff)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_enabled)( c99_buffer_obj,
                        ::NS(SCCoasting_enabled)( cmp_obj ) ) );
            ...
            case 2:
            {
                c99_buffer_obj = ::NS(SCCoasting_cbuffer_add)( c99_buffer,
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ),
                        ::NS(SCCoasting_circumference)( cmp_obj ),
                        ::NS(SCCoasting_sigma_x)( cmp_obj ),
                        ::NS(SCCoasting_sigma_y)( cmp_obj ),
            ...
            case 3:
            {
                c99_buffer_obj = ::NS(SCCoasting_cbuffer_add_copy)(
                    c99_buffer, cmp_obj );
                break;
            }
            ...
            case 4:
            {
                c99_buffer_obj = ::NS(SCCoasting_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)( cmp_obj, c99_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)(
        ...
        switch( cxx_buffer_mode )
        {
            case 0:
            {
                cxx_buffer_obj = ::NS(SCCoasting_cbuffer_new)(
                    cxx_buffer.as_c_api() );

                ASSERT_TRUE( cxx_buffer_obj != nullptr );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_number_of_particles)( cxx_buffer_obj,
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_circumference)( cxx_buffer_obj,
                        ::NS(SCCoasting_circumference)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_x)(
                    cxx_buffer_obj, ::NS(SCCoasting_sigma_x)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_sigma_y)(
                    cxx_buffer_obj, ::NS(SCCoasting_sigma_y)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_length)(
                    cxx_buffer_obj, ::NS(SCCoasting_length)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_x_co)(
                    cxx_buffer_obj, ::NS(SCCoasting_x_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_set_y_co)(
                    cxx_buffer_obj, ::NS(SCCoasting_y_co)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_min_sigma_diff)( cxx_buffer_obj,
                        ::NS(SCCoasting_min_sigma_diff)( cmp_obj ) ) );

                ASSERT_TRUE( st::STATUS_SUCCESS ==
                    ::NS(SCCoasting_set_enabled)( cxx_buffer_obj,
                        ::NS(SCCoasting_enabled)( cmp_obj ) ) );
            ...
            case 2:
            {
                cxx_buffer_obj = ::NS(SCCoasting_cbuffer_add)(
                    cxx_buffer.as_c_api(),
                        ::NS(SCCoasting_number_of_particles)( cmp_obj ),
                        ::NS(SCCoasting_circumference)( cmp_obj ),
                        ::NS(SCCoasting_sigma_x)( cmp_obj ),
            ...
            case 3:
            {
                cxx_buffer_obj = ::NS(SCCoasting_cbuffer_add_copy)(
            ...
            case 4:
            {
                cxx_buffer_obj = ::NS(SCCoasting_from_cobj_index)(
        ...
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)( cmp_obj, cxx_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)(
    ...
    for( size_type ii = 0u ; ii < NUM_BELEMENTS ; ++ii )
    {
        auto c99_buffer_obj = ::NS(SCCoasting_const_from_cbuffer)( c99_buffer, ii );
        auto cxx_buffer_obj = cxx_buffer.get_object< elem_type >( ii );
        auto flat_buffer_obj = ::NS(SCCoasting_const_from_cobj_flat_buffer)(
        ...
        ASSERT_TRUE( cxx_buffer_obj  == ::NS(SCCoasting_const_from_cbuffer)(
            cxx_buffer.as_c_api(), ii ) );

        auto cmp_obj = &CMP_ELEMENTS[ ii ];

        ASSERT_TRUE( cmp_obj != flat_buffer_obj );
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)( cmp_obj, flat_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)( cmp_obj, c99_buffer_obj ) );
        ASSERT_TRUE( 0 == ::NS(SCCoasting_compare)( cmp_obj, cxx_buffer_obj ) );
    }
    ...
    real_type const saved_x_co = ::NS(SCCoasting_x_co)( flat_buffer_obj );

    do
    {
        ASSERT_TRUE( ::NS(SCCoasting_set_x_co)(
            ::NS(SCCoasting_from_cobj_flat_buffer)(
                flat_buffer, 0, slot_size ), xy_co_dist( prng )
            ) == st::STATUS_SUCCESS );
    }
    while( 0 == ::NS(Type_value_comp_result)( saved_x_co,
           ::NS(SCCoasting_x_co)( flat_buffer_obj ) ) );

    ASSERT_TRUE( 0 != ::NS(SCCoasting_compare)(
        &CMP_ELEMENTS[ 0 ], flat_buffer_obj ) );

    ASSERT_TRUE( st::STATUS_SUCCESS == ::NS(SCCoasting_copy)(
        ::NS(SCCoasting_from_cobj_flat_buffer)( flat_buffer, 0u, slot_size ),
            &CMP_ELEMENTS[ 0 ] ) );
